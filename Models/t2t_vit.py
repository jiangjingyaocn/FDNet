...
class T2T_ViT(nn.Module):
    def __init__(self, img_size=384, tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
...
def T2t_vit_14(pretrained=False, **kwargs):  # adopt performer for tokens to token
    ...
    model = T2T_ViT(tokens_type='performer', embed_dim=384, depth=14, num_heads=6, mlp_ratio=3.)
