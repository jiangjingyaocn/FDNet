...
def test_net(args):
    ...
    model_path = args.save_model_dir + 'FDNet.pth'
    ...
    for test_dir_img in test_paths:
        ...
        test_loader = data.DataLoader(dataset=test_dataset, batch_size=1, shuffle=False, num_workers=6)
        print('''
                   Starting testing:
                       dataset: {}
                       Testing size: {}
        ...
        for i, data_batch in enumerate(test_loader):
            ...
            # save saliency maps
            save_test_path = args.save_test_path_root + dataset + '/FDNet/'
